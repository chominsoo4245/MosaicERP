package kr.cms.serialService.logging;
...
public class LogSender {
    ...
    private static final String SERIAL_AUDIT_LOG = "serial-audit-log";

    private void sendAuditLog(AuditLogDTO dto){
        kafkaTemplate.send(SERIAL_AUDIT_LOG, dto).whenComplete((res, ex) -> {
            if(ex != null) {
