package kr.cms.itemBff.logging;
...
public class LogSender {
    ...
    private static final String ITEM_BFF_AUDIT_LOG = "item-bff-audit-log";

    private void sendAuditLog(AuditLogDTO dto){
        kafkaTemplate.send(ITEM_BFF_AUDIT_LOG, dto).whenComplete((res, ex) -> {
            if(ex != null) {
