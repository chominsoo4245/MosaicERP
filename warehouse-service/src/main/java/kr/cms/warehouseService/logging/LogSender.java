package kr.cms.warehouseService.logging;
...
public class LogSender {
    ...
    private static final String WAREHOUSE_AUDIT_LOG = "warehouse-audit-log";

    private void sendAuditLog(AuditLogDTO dto){
        kafkaTemplate.send(WAREHOUSE_AUDIT_LOG, dto).whenComplete((res, ex) -> {
            if(ex != null) {
