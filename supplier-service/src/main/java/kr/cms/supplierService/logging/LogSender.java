package kr.cms.supplierService.logging;
...
public class LogSender {
    ...
    private static final String SUPPLIER_AUDIT_LOG = "supplier-audit-log";

    private void sendAuditLog(AuditLogDTO dto){
        kafkaTemplate.send(SUPPLIER_AUDIT_LOG, dto).whenComplete((res, ex) -> {
            if(ex != null) {
